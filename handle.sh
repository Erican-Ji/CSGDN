# 读取目录 ./results/napus/CSGDN/tmp_search 下的所有文件的最后一行，将其追加到 ./results/napus/CSGDN/search.txt
for file in ./results/cotton_80/CSGDN/tmp_search/*
do
    echo $file >> ./results/cotton_80/CSGDN/search.txt
    tail -n 1 $file >> ./results/cotton_80/CSGDN/search.txt
done
...
# for file in ./results/napus/CSGDN/tmp_search/*
# do
